...
wget --content-disposition --inet4-only 'https://pm.puppet.com/cgi-bin/download.cgi?dist=ubuntu&rel=18.04&arch=amd64&ver=latest' 
...
gunzip puppet-enterprise-2023.5.0-ubuntu-18.04-amd64.tar.gz

#then tar xvf
echo 'Extracting the files in tar archive'
tar xvf puppet-enterprise-2023.5.0-ubuntu-18.04-amd64.tar


# Remove the tar archive file
rm puppet-enterprise-2023.5.0-ubuntu-18.04-amd64.tar

echo 'Change working directory to puppet folder'
cd puppet-enterprise-2023.5.0-ubuntu-18.04-amd64
